function init_log_file(log_file, use_backbone, inverse_backbone, version)
...
% Header builder
% ============================================================
function header = build_header(use_backbone, inverse_backbone, version)
    ...
    base_cols = { ...
        ...
        'ExperimentID', 'Seed', 'ThresholdMode', 'TrophicLevelProtocol', ...
        'TrophicSnapshotFile' ...
    };

    if any(strcmpi(strtrim(char(string(version))), {'WLNM_dir_neg', 'WLNM_dir_neg_kfold'}))
        negative_sampling_cols = { ...
        ...
        base_cols = [base_cols, negative_sampling_cols];
    end
    ...
    { ...
        ...
        'TrainNumSpecies', ...
        'TrainConnectance', ...
        'TrainMeanTrophicLevel', ...
        'TrainMeanDegree', ...
        'TrainMeanGenerality', ...
        'TrainMeanVulnerability' ...
    }, ...
    extended_structural_cols('Train'), ...
    networkx_trophic_diagnostic_cols('Train'), ...
    { ...
        'TrainPropBasal', ...
        'TrainPropIntermediate', ...
        'TrainPropTop', ...
        'PseudoNumSpecies', ...
        'PseudoLinks', ...
        'PseudoConnectance', ...
    ...
    trophic_v2_cols = [ ...
        trophic_v2_diagnostic_cols('Empirical'), ...
        trophic_v2_diagnostic_cols('Train'), ...
        trophic_v2_diagnostic_cols('Pseudo') ...
    ];
...
function cols = trophic_v2_diagnostic_cols(prefix)
    suffixes = { ...
        'NumSpeciesFull', 'NumSpeciesLargest', 'NumSpeciesWithLevel', ...
        'LargestFraction', 'StatusCode', 'NumBasal', 'NumUnreachable', ...
        'ReciprocalCondition', 'ScaledResidual', 'ResidualNorm', ...
        'CandidateMin', 'CandidateMax', 'AboveLegacyCap', ...
        'PrecisionDigits', 'PrecisionRelativeDifference', 'SolverCode', ...
        'FailureReason', 'LegacyMean', 'LegacyStatusCode' ...
    };
    cols = cellfun(@(suffix) [prefix 'TrophicV2' suffix], suffixes, ...
        'UniformOutput', false);
end
