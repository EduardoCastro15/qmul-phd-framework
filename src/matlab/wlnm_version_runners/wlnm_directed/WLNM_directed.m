function [roc_auc, pr_auc, best_threshold, best_precision, best_recall, best_f1_score, aux] = ...
    ...
    test_metrics = compute_binary_classification_metrics_directed(binary_predictions, test_label);
...
function metrics = compute_binary_classification_metrics_directed(predictions, labels)
