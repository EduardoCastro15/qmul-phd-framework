...
CALL gds.beta.pipeline.linkPrediction.create('PP1I3_pipe')

// Add node properties (embedding)
CALL gds.beta.pipeline.linkPrediction.addNodeProperty('PP1I3_pipe', 'node2vec', {
...
CALL gds.beta.pipeline.linkPrediction.addFeature('PP1I3_pipe', 'HADAMARD', {
    nodeProperties: ['embedding', 'mass']
}) YIELD featureSteps
 
 // Add logistic regression
CALL gds.beta.pipeline.linkPrediction.addLogisticRegression('PP1I3_pipe') YIELD parameterSpace

// Train model
CALL gds.beta.pipeline.linkPrediction.train('PP1I3', {
    modelName: 'PP1I3_model',
    pipeline: 'PP1I3_pipe',
    metrics: ['AUCPR'],
...
// Stream prediction
CALL gds.beta.pipeline.linkPrediction.predict.stream('PP1I3',{
    modelName: 'PP1I3_model',
    sampleRate: 1,
    topN: 40,
    threshold: 0.3
...
// Drop pipeline, model and projection
 CALL gds.pipeline.drop('PP1I3_pipe');
 CALL gds.model.drop('PP1I3_model');
 CALL gds.graph.drop('PP1I3');
